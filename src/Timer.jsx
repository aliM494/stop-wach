...
class Timer extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="Timer">
          <h2 className={`${s < 1 ? "before_Hover" : "After_Hover"}`}>
            Hover Me!!!
          </h2>
          <div
            className={`${s < 1 ? "Timer_container" : ""} Timer_watch 
            ${s > 0 ? "Timer_watch_H" : ""} `}
          >
            <h2
          ...
          <ul className={`${s < 1 ? "Timer_container" : ""}`}>
            <li
              className={`${!this.state.IsStart ? "play" : "stop"}`}
              onClick={!this.state.IsStart ? this.start : this.stop}
            >
              <a href="#">
                <i
                  id="Changer_icon"
                  className={`fa ${
                    !this.state.IsStart ? "fa-play" : "fa-pause"
                  }`}
                ></i>
              </a>
            </li>
            <li className="reset" onClick={this.reset}>
              <a href="#">
